 ...
 * - route: 效果路由目标，如 "DamageEffect", "TurnEffect+StatusEffect"
...
window.SkillEffects = {
    ...
    // 1. 王·焚世烈焰 - 无视微弱
    // route: DamageEffect.ignoreWeaken | owner: self
    ...
    // 王·焚世烈焰 - 对手异常时伤害提升
    // route: DamageEffect.conditionalBoost | owner: self
    ...
    // 王·焚世烈焰 - 对手无异常时吸取体力
    // route: HealEffect.drain | owner: self+opponent
    ...
    // 不败之境 - 4回合吸取1/3最大体力
    // route: TurnEffect+HealEffect+DamageEffect | owner: self
    ...
    // route: StatEffect.steal+HealEffect.drain | owner: self
    ...
    // 无视免疫攻击
    // route: DamageEffect.ignoreImmune | owner: self
    ...
    // 王·洛水惊鸿 - 无视微弱和护盾
    // route: DamageEffect.ignoreWeaken+ignoreShield | owner: self
    ...
    // 王·洛水惊鸿 - 附加20%最大体力固伤
    // route: DamageEffect.percent | owner: opponent
    ...
    // 沧海永存 - 恢复满体力，<1/2则等量固伤
    // route: HealEffect+DamageEffect | owner: self+opponent
    ...
    // 烈火净世击 - 反转强化成功则满体力满PP
    // route: StatEffect.invert+HealEffect | owner: self
    ...
    // 混沌灭世决 - 每项同级能力+120固伤
    // route: DamageEffect.fixed | owner: opponent
    ...
    // 混沌魔域 - 100%害怕/吸取1/3体力
    // route: StatusEffect|HealEffect.drain | owner: opponent
    ...
    // 诸雄之主 - 30%三倍伤害，强化时60%
    // route: DamageEffect.conditionalMultiple | owner: self
